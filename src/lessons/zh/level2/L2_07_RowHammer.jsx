  ...
  return (
    <div className="lesson-prose">
      <div className="mb-6">
        ...
        <p className="text-dram-muted mt-2">电荷泵机制、sub-20 nm 工艺下的比特翻转、TRR 绕过，以及 DDR5 RFM</p>
      </div>
      ...
      <div className="rounded-lg p-4 bg-dram-blue/5 border border-dram-blue/20 text-sm text-dram-muted mb-6">
        ...
        攻击者可以通过数百万次反复激活某一行，故意导致<em>相邻</em>行发生比特翻转——
        而无需直接访问受害行的数据。
      </div>
      ...
      <p>
        ...
        仅需 <strong>139,000 次激活</strong>就足以翻转比特——
        这比制造商预估的威胁阈值低了几个数量级。
      </p>
      ...
      <ul>
        <li><strong>权限提升：</strong>翻转页表项中的某个比特，可将用户页重新映射到特权物理页。</li>
      ...
      <p>
        <strong>PARA（概率相邻行激活，Probabilistic Adjacent Row Activation）：</strong>
      ...
      <div className="rounded-lg overflow-hidden border border-dram-border text-xs mt-4">
        ...
        {[
          ...
          ['ECC + scrubbing', '事后纠正单比特翻转', '扫描增加延迟与带宽开销'],
        ].map(([mit, eff, oh]) => (
